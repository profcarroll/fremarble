...
def push_out_of_wall(cx, cy, rect, wall):
    r = level.MARBLE_RADIUS
    left_pen = rect.right - wall.left
    right_pen = wall.right - rect.left
    top_pen = rect.bottom - wall.top
    bottom_pen = wall.bottom - rect.top
